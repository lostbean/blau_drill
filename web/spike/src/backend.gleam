...
//// in-browser simulator implement. It is the Phase-2-facing seam: a `Backend`
//// is a record of effectful functions, so the Lustre app never branches on
...
/// object behind this type; the app only ever passes it back to the same
/// backend's functions.
pub type Conn
